...
To limit the output, we can use the generic `summary` output of the object which returns a summary table of the aggregate median/average asmd per covariate.
