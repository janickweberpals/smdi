...
Another great way to explore the patterns of missingness is the `md.pattern` function which is part of the `mice` package.
...
MCAR: No association in neither crude nor adjusted model
MAR: Association in crude but not adjusted model
MNAR: If there was a meaningful difference also after comprehensive adjustment (log HR), this may be indicative of differential MNAR scenarios
